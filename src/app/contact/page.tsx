                      ...
                      {getDaysInMonth().map((d, index) => {
                        ...
                        return (
                          <div
                            ...
                            className={`h-11 flex items-center justify-center text-xs font-semibold border-b border-r border-gray-100 transition-all ${!d.isCurrentMonth ? 'text-gray-300 bg-gray-50/20 pointer-events-none' : ''
                              } ${isAvailable ? 'cursor-pointer hover:scale-[1.05] border-primary/20' : 'text-gray-400 pointer-events-none'
                              }`}
                          >
                            <span
                              className={`w-7 h-7 flex items-center justify-center rounded-full ${isAvailable && !isSelected ? 'text-primary font-bold' : ''
                                }`}
                        ...
                        <div className="grid grid-cols-4 gap-2">
                          {availableHours.map(hour => (
                            <button
                              ...
                              className={`py-2 rounded-xl text-xs font-bold border transition-all text-center ${selectedBookingHour === hour
